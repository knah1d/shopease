...
public class SSLCommerzService {
    ...
    private Map<String, Object> buildSSLCommerzRequest(PaymentInitiationRequest request, String transactionId) {
        ...
        params.put("cus_add1", request.getCustomerAddress() != null ? request.getCustomerAddress() : "Customer Address");
        ...
        // Product information
        params.put("product_name", request.getProductName() != null ? request.getProductName() : "Order #" + request.getOrderId());
